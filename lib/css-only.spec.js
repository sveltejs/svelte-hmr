...
import { normalizeNonJs } from './css-only.js'
...
describe('normalizeNonJs', () => {
  ...
  test.skip('new selector', shouldNeverChange(), [
    `
      <script>
        import Foo from './Foo.svelte'
      </script>
  ...
  test.skip('remove selector', shouldNeverChange(), [
    `
      <script>
        import Foo from './Foo.svelte'
      </script>
  ...
  test.skip('nested elements', shouldNeverChange(), [
    `
      <script>
        import Foo from './Foo.svelte'
        let x = 0
